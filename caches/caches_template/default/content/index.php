...
<div class="container">
		<div id="slides2">
			<img src="<?php echo IMG_PATH;?>ysdh/example-slide-1.jpg" alt="">
			<img src="<?php echo IMG_PATH;?>ysdh/example-slide-2.jpg" alt="">
			<img src="<?php echo IMG_PATH;?>ysdh/example-slide-3.jpg" alt="">
			<img src="<?php echo IMG_PATH;?>ysdh/example-slide-4.jpg" alt="">
		</div>
	...
	<div class="navbar2">
		<div class="container">
			<h2><i class="tel">电话</i><span>400-1234-1234</span></h2>
			<div>
				<a href="#"><i class="info"></i>开班信息</a>
...
<div class="container">
	...
	<div class="row">
		<div class="span12 opus">
			...
			<div class="item">
				<dl>
					<dt><img src="<?php echo IMG_PATH;?>ysdh/assets/z.jpg"> </dt>
					<dd>
						<h4>《机械侠》</h4>
						<p>这个理是好的这个理是好的这个理是好的</p>
					</dd>
				</dl>
			</div>
			<div class="item">
